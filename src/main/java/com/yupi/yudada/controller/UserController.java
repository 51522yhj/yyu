...
import com.yupi.yudada.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Boolean> resetPassword(@RequestBody PasswordResetRequest passwordResetRequest , HttpServletRequest request) {
        if (passwordResetRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        else {
            return ResultUtils.success(userService.resetPassword(passwordResetRequest,request));
        }
    }
    /**
     * 用户登录
